...
from canshu.bz import *
from canshu.zh import ZhangHu
from orange.coroutine import run
from canshu.transaction import *
from mongo.czbank.accounting import Accounting
from canshu.jgm import GgJgm
from canshu.branch import Branch
...
def sjdr():
    ...
    for cls, fn in ShuJuList:
        print('处理文件：%s' % (fn))
        cls.load_files(fn)
    from canshu.zhanghu import AcTemplate
    print('导入内部账户模板')
